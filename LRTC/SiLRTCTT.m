...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [X, errList] = SiLRTCTT(T, Omega, alpha, gamma, maxIter, epsilon, X)
%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for k = 1:maxIter
    if mod(k, 20) == 0
        fprintf('SiLRTC-TT: iterations = %d   difference=%f\n', k, errList(k-1));
    end
    Xsum = 0;
    for i = 1:ndims(T)
...
fprintf('SiLRTC-TT ends: total iterations = %d   difference=%f\n\n', k, errList(k));